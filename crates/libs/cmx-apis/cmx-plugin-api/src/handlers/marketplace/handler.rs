...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "更新成功", body = cmx_api_core::UnitResp)
    ),
    tag = "MarketplacePlugin"
)]
pub async fn marketplace_plugin_update(
...
) -> Result<Json<cmx_api_core::UnitResp>> {
    ...
    Ok(Json(cmx_api_core::UnitResp::msg("更新成功")))
}
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "删除成功", body = cmx_api_core::UnitResp)
    ),
    tag = "MarketplacePlugin"
)]
pub async fn marketplace_plugin_delete(
    ...
    Ok(Json(cmx_api_core::UnitResp::msg("删除成功")))
}
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "评分成功", body = cmx_api_core::UnitResp)
    ),
    tag = "MarketplacePlugin"
)]
pub async fn marketplace_plugin_rate(
    ...
    Ok(Json(cmx_api_core::UnitResp::msg("评分成功")))
}
