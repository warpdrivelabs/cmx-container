...
pub async fn send_message(
    ...
    match client.prompt_async(&sid, &body).await {
        ...
        Err(e) => {
            ...
            cmx_api_core::Error::from(e).into_response()
        }
    }
}
...
pub async fn context_request(
    ...
    let reg = match get_registry() {
        Some(r) => r,
        None => {
            return Err(cmx_api_core::Error::ServiceUnavailable(
    ...
    match tokio::time::timeout(std::time::Duration::from_secs(30), rx).await {
        ...
        Ok(Err(_)) => {
            ...
            Err(cmx_api_core::Error::InternalError(
...
fn require_client() -> Result<&'static cmx_ai::OpenCodeClient> {
    get_client().ok_or_else(|| {
        cmx_api_core::Error::ServiceUnavailable(
