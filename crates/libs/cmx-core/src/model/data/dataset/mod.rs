...
mod tests {
    ...
    fn test_nested_structure() {
        ...
        // B. 构建主数据行 (订单头)
        let mut header_row = Row::new(vec![1001.into(), "SO-20231027".into()]);
    ...
    fn test_roundtrip_serialize_deserialize() {
        ...
        assert_eq!(
            ds2.iter()
                .next()
                .unwrap()
                .get_by_name(ds2.schema.as_ref(), "a"),
    ...
    fn test_dataset_uuid_serialization() {
        ...
        let row = Row::new(vec![DataValue::Int(1), DataValue::Uuid(order_uuid)]);
