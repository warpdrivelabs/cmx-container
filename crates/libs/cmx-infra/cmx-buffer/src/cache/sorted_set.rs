...
impl SortedSetOps {
     ...
     * @param start 起始索引
     * @param stop 结束索引
     * @return Result<Vec<(String, f64)>> 成员及其分数的列表
     */
     ...
     * @param key 键名
     * @param member 成员
     * @return Result<Option<f64>> 成员的分数（如果存在）
     */
     ...
     * @param key 键名
     * @param member 成员
     * @return Result<Option<u64>> 成员的排名（如果存在）
     */
     ...
     * @param key 键名
     * @param count 弹出数量
     * @return Result<Vec<(String, f64)>> 弹出的成员及其分数列表
     */
