...
impl SetOps {
     ...
     * 获取集合的所有成员
     * @param key 键名
     * @return Result<Vec<String>> 集合中所有成员的列表
     */
     ...
     * @return Result<Vec<bool>> 每个成员是否存在的情况列表
     */
     ...
     * 随机移除并返回集合中的一个成员
     * @param key 键名
     * @return Result<Option<String>> 随机成员
     */
     ...
     * @param key 键名
     * @param count 移除数量
     * @return Result<Vec<String>> 被移除的成员列表
     */
     ...
     * 随机获取集合中的多个成员（不移除）
     * @param key 键名
     * @param count 获取数量（正数获取不重复，负数获取可能重复）
     * @return Result<Vec<String>> 随机成员列表
     */
    ...
    /**
     * 获取集合之间的差集
     * @param keys 集合键名列表（第一个集合减去后续集合）
     * @return Result<Vec<String>> 差集结果
     */
