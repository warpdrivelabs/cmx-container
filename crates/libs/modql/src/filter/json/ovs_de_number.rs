...
use crate::filter::{
    OpValFloat64, OpValInt32, OpValInt64, OpValsFloat64, OpValsInt32, OpValsInt64,
};
...
impl<'de> Visitor<'de> for Int64OpValsVisitor {
    ...
    fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        write!(
            formatter,
            "OpValsInt64 visitor not implemented for this type."
        )
    }
        ...
        M: MapAccess<'de>,
    {
        ...
        while let Some(k) = map.next_key::<String>()? {
            ...
            let opval =
                OpValInt64::op_value_to_op_val_type(&k, value).map_err(serde::de::Error::custom)?;
            opvals.push(opval)
        }
...
impl<'de> Visitor<'de> for Int32OpValsVisitor {
    ...
    fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        write!(
            formatter,
            "OpValsInt32 visitor not implemented for this type."
        )
    }
        ...
        M: MapAccess<'de>,
    {
        ...
        while let Some(k) = map.next_key::<String>()? {
            ...
            let value = map.next_value::<Value>()?;
            let opval =
                OpValInt32::op_value_to_op_val_type(&k, value).map_err(serde::de::Error::custom)?;
            opvals.push(opval)
        }
...
impl<'de> Visitor<'de> for FloatOpValsVisitor {
    ...
    fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
        write!(
            formatter,
            "OpValsFloat64 visitor not implemented for this type."
        )
    }
        ...
        M: MapAccess<'de>,
    {
        ...
        while let Some(k) = map.next_key::<String>()? {
            // Note: Important to always
            let value = map.next_value::<Value>()?;
            let opval = OpValFloat64::op_value_to_op_val_type(&k, value)
