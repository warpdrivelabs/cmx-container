...
/// let app = Router::new()
///     .with_state(mm);
/// let app = register_crud_routes!(app, DomainBmc, "/api/domains");
/// ```
#[macro_export]
macro_rules! register_crud_routes {
    ($router:expr, $mc:ty, $prefix:expr) => {
        $router
            ...
            .route(concat!($prefix, "/list"), axum::routing::get($crate::rest::handler::list::<$mc>))
            .route(concat!($prefix, "/page"), axum::routing::post($crate::rest::handler::page::<$mc, _>))
    };
}
