...
> **2026-08-14 重写**：本文是原《RPC架构流程详解.md》的全面重写版，与「RPC 皮肤归域 + 契约集中」重构落地代码完全同步（重构方案与落地记录见根仓库 [20260814_cmx-rpc_RPC皮肤归域与契约集中重构方案.md](../../../documents/20260814_cmx-rpc_RPC皮肤归域与契约集中重构方案.md)）。「皮肤 / 归域 / 契约集中 / 装配显式」等自造词的出处与含义见下方[术语说明](#术语说明)。
>
> 内容基于以下最新源码：
