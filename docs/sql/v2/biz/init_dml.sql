...
--     头 name/short_name/类型分类/资质联系/商务结算/风险治理字段 + supplier_bank（cm_bank_account）/supplier_contact（cm_supplier_contact）明细。
-- ─────────────────────────────────────────────
