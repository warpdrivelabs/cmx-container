...
CREATE UNIQUE INDEX IF NOT EXISTS uk_cmx_domain_codee ON cmx_domain(code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_cmx_application_codee ON cmx_application(code);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_cmx_module_codee ON cmx_module(code);
